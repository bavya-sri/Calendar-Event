...
function sendNetworkLog(
    ...
    state,
    version) {
  var formid = "1FAIpQLSc3g56Kb_wqQUdFmqWAIYwBr8CLV_ofM9sWqg-8VKUzL5zubA";
  var data = {
    "entry.1256960966": uid,
    "entry.1158096879": time,
    "entry.446175194": name,
    "entry.32345345": target,
    "entry.1599959651": info,
    "entry.780903368": state,
    "entry.1087500068": version,
  };
  var params = [];
  for (key in data) {

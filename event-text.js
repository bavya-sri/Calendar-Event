...
function clearInput()
{
	...
	document.getElementById("all-day-event-checkbox").value = false;
	document.getElementById("event-start-date").value = "";
	document.getElementById("event-end-date").value = "";
	document.getElementById("all-day-event-date").value = "";
	document.getElementById("recurrent-event-type-selector").value = "";
	document.getElementById("recurrent-event-end-date-row").value = "";
	document.getElementById("recurrent-event-details-line").value = "";
	document.getElementById("recurrent-event-content").value = "";
	document.getElementById("daily-recurrent-details").value = "";
	document.getElementById("yearly-recurrent-freq").value = "";
}
